# Panduan Deployment MGS

Dokumen ini menjelaskan cara melakukan deployment aplikasi MGS di server baru dengan data fresh.
...
Salin file [.env.example](file:///e:/MGS211025/.env.example) ke .env:
...
Script ini akan:
1. Menjalankan semua file migrasi di folder [migrations/](file:///e:/MGS211025/migrations)
...
Jika Anda memiliki data dari sistem lama, Anda dapat menggunakan file migrasi di folder [data/backup/](file:///e:/MGS211025/data/backup/) untuk mengimpor data.
