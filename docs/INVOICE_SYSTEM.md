# Sistem Cetak Invoice - MGS

## Overview
Sistem cetak invoice adalah fitur utama aplikasi MGS yang memungkinkan admin untuk mencetak dan mengunduh invoice dalam format yang dapat dicetak atau PDF.
...
```json
{
  "company_header": "MAYA GLOBAL SOLUTION",
...
```json
{
  ...
  "payment_account_holder": "MAYA GLOBAL SOLUTION",
