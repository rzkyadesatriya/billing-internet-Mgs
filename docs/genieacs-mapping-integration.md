...
## 📋 **Overview**
Dokumen ini menjelaskan integrasi lengkap antara sistem GenieACS (ONU Device Management) dengan fitur Network Mapping MGS-Billing. Integrasi ini memungkinkan admin untuk memvisualisasikan device ONU secara geografis dengan koordinat customer yang terintegrasi.
