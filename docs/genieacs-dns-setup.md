...
#### **B. Konfigurasi Otomatis (Semua ONU)**
...
## ðŸ“Š **Monitoring dan Verifikasi**
...
## ðŸ“‹ **Parameter DNS yang Didukung**
...
0 * * * * cd /path/to/MGS && node scripts/integrate-genieacs-dns-billing.js --auto
```
