# Update: Mikrotik PPPoE & Isolir Profile Integration

Tanggal: 2025-08-11

Repo: https://github.com/alijayanet/MGS
...
git status
git add .
git commit -m "release: v1.2.0 â€“ PPPoE dropdown & isolir profile"
...
- __Konfigurasi Profil Isolir di Service Suspension__
  ...
  - Endpoint baru:
    - `GET /admin/billing/service-suspension/isolir-profile` â†’ ambil profil isolir tersimpan.
    - `POST /admin/billing/service-suspension/isolir-profile` â†’ simpan profil isolir.
