...
function formatWithHeaderFooter(message) {
    try {
        ...
        const FOOTER_INFO = FOOTER_SEPARATOR + getSetting('footer_info', "Powered by MAYA GLOBAL SOLUTION");
        ...
        return `📱 MAYA GLOBAL SOLUTION 📱

${message}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Powered by MAYA GLOBAL SOLUTION`;
    }
}
                    ...
                    if (fs.existsSync(superAdminPath)) {
                        ...
                        if (superAdminNumber) {
                            ...
                            const welcomeMessage = `*Selamat datang!*\n\n` +
                                ...
                                `Rekening untuk pengembangan aplikasi MGS-Billing\n` +
                                `70910102017534\n` +
