                ...
                if (type === 'income') {
                    ...
                    sql = `
                        ...
                        SELECT 
                            ...
                            p.payment_method,
                            CASE 
                                WHEN p.payment_type = 'collector' THEN 'Kolektor - ' || COALESCE(col.name, 'Unknown')
                            ...
                            c.phone as customer_phone,
                            CASE 
                                WHEN p.payment_type = 'collector' THEN 'Pembayaran via kolektor ' || COALESCE(col.name, 'Unknown')
                                ELSE ''
                            END as description,
                            p.notes,
