...
echo "  - Check status: pm2 status MGS"
echo "  - View logs: pm2 logs MGS"
echo "  - Restart: pm2 restart MGS"
echo "  - Stop: pm2 stop MGS"
echo ""
...
echo ""
echo "ðŸŽ¯ MGS is now running on port 3002!"
...
echo ""
log_success "ðŸŽ‰ Deploy selesai! Aplikasi siap digunakan."
